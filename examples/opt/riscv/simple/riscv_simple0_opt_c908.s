        ...
        vmul.vv v12, v7, v8            // ........*......................................
        vnmsac.vx v23, x12, v17        // ........*......................................
        vmulhu.vv v8, v7, v26          // ..........*....................................
        vnmsac.vx v9, x12, v14         // ..........*....................................
        vsub.vv v6, v16, v23           // ............*..................................
        vmulhu.vv v23, v22, v31        // ............*..................................
        vnmsac.vx v12, x12, v8         // ..............*................................
        vsub.vv v3, v13, v9            // ..............*................................
        vadd.vv v16, v16, v6           // ................*..............................
        vnmsac.vx v20, x12, v23        // ................*..............................
        vadd.vv v13, v13, v3           // ..................*............................
        vmulhu.vv v2, v1, v24          // ..................*............................
        vsub.vv v6, v7, v12            // ....................*..........................
        vsub.vv v21, v22, v20          // ....................*..........................
        vnmsac.vx v18, x12, v2         // ......................*........................
        vmulhu.vv v20, v19, v30        // ......................*........................
        vadd.vv v22, v22, v21          // ........................*......................
        vadd.vv v7, v7, v6             // ........................*......................
        vnmsac.vx v0, x12, v20         // ..........................*....................
        vmulhu.vv v5, v4, v25          // ..........................*....................
        vmul.vv v3, v10, v11           // ............................*..................
        ...
        vadd.vv v19, v19, v9           // ..................................*............
        vadd.vv v1, v1, v0             // ....................................*..........
        vnmsac.vx v3, x12, v11         // ....................................*..........
        vnmsac.vx v15, x12, v5         // ......................................*........
        vsub.vv v9, v10, v3            // ........................................*......
        vsub.vv v3, v4, v15            // ..........................................*....
        vadd.vv v10, v10, v9           // ............................................*..
        vadd.vv v4, v4, v3             // ..............................................*
